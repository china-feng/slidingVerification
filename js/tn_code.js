...
var tncode = {
    ...
    _send_result:function(){
        ...
        re.request('get',tncode.check_url + '?tn_r='+tncode._mark_offset, haddle);
    },
    ...
    refresh:function(){
        ...
        // var img_url = tncode._currentUrl()+"tncode.php?t="+Math.random(); //刷新
        var img_url = tncode.img_make_url + "?t=" + Math.random;
